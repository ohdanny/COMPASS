...
from COMPASS.compass.inference import compass_fit_gene
from COMPASS.compass.splines import build_bspline_basis, build_basis_to_rank
...
from sim import build_grid, build_W, build_truth, simulate_counts,compute_power,setup_pi_y_plots
from checks import sanity_checks
...
def setup_loger(clear:bool=True):
    # clear log file
    if clear:
    ...
    return logging.getLogger("COMPASS Demo Simulation")
